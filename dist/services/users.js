 ...
 */
const validateAndHashPassword = (password, confirmPassword) => __awaiter(void 0, void 0, void 0, function* () {
...
const createUser = (userObject) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { status, message, hashedPassword } = yield validateAndHashPassword(password, confirmPassword);
    if (status !== 200) {
...
//------------------------------------------------------------------------------
const signIn = (userObject) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_js_1.default.findOne(userQuery);
...
//------------------------------------------------------------------------------
const resetPassword = (userInput) => __awaiter(void 0, void 0, void 0, function* () {
    /**
    ...
    if (email) {
        ...
        user = yield user_js_1.default.findOne({ email });
        if (!user) {
            return {
                status: 404,
                message: message_js_1.default.users.userNotExistsErr("email"),
        ...
        if (!oldPassword || !(yield bcryptjs_1.default.compare(oldPassword, user.password))) {
            return {
                status: 400,
    ...
    const { status, message, hashedPassword } = yield validateAndHashPassword(newPassword, confirmPassword);
    if (status !== 200) {
        return { status, message: message || "" };
    }
